...
public class SwipeMenuListView extends XListView {
	...
	public static interface OnMenuItemClickListener {
		boolean onMenuItemClick(int position, SwipeMenuView menu, int index);
	}

	public static interface OnSwipeListener {
		void onSwipeStart(SwipeMenuView menuView, int position);

		void onSwipeEnd(SwipeMenuView menuView, int position);
	}
}
