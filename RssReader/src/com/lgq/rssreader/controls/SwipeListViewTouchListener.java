...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private boolean swipeAutoClose = true;
    ...
    /**
     * Sets auto close when after swipe
     *
     * @param swipeAutoClose
     */
    public void setSwipeAutoClose(boolean swipeAutoClose) {
        this.swipeAutoClose = swipeAutoClose;
    }
    
    /**
     * Get auto close when after swipe
     *
     * @param swipeAutoClose
     */
    public boolean getSwipeAutoClose(boolean swipeAutoClose) {
        return swipeAutoClose;
    }
...
//                            if (opened.get(position)) {
//                                if (!swap) {
//                                	moveBack = openedRight.get(position) ? -(int) (viewWidth - rightOffset) : -(int) (-viewWidth + leftOffset);
//                                }
//                            } else {
//                                if (swap) {
